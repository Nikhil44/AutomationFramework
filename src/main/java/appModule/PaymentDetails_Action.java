	...
	// iTestcaseRow is the row number of our Testcase name in the Test Data sheet
		...
		public static void execute(int iTestCaseRow) throws Exception{
			...
			try{
				...
				LogClass.info(sEmail +" is entered as First Name on the Payment detail page");
				...
				LogClass.info(sFirstName +" is entered as First Name on the Payment detail page");
				...
				LogClass.info(sLastName +" is entered as Last Name on the Payment detail page");
				...
				LogClass.info(sAddress +" is entered as Address on the Payment detail page");
				...
				LogClass.info(sCity +" is entered as City on the Payment detail page");

				String sCountry = ExcelUtils.getCellData(iTestCaseRow, Constant.Col_Country);

				PaymentDetails_Page.drpdwn_Country(sCountry);

				LogClass.info(sCountry +" is Selected as Country on the Payment detail page");
				...
				LogClass.info(sPhone +" is entered as Phone on the Payment detail page");
				...
				if(!PaymentDetails_Page.chkbx_SameAsBillingAdd().isSelected()){
					...
					LogClass.info("Same as Billing address check box is selected on the Payment detail page");
				...
				LogClass.info("Click action is performed on Purchase button on the Payment detail page");
