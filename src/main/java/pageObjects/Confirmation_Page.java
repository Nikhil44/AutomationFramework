...
public class Confirmation_Page extends BaseClass{
    ...
    public static WebElement txt_ProductName() throws Exception{
        ...
        try{ 
        	 ...
        	 LogClass.info("Product name is found on the Confirmation Page");

        }catch (Exception e){

        	LogClass.error("Product name is not found on the Confirmation Page");
    ...
    public static WebElement txt_ProductPrice() throws Exception{
        ...
        try{ 
        	 ...
        	 LogClass.info("Product price is found on the Confirmation Page");

        }catch (Exception e){

        	LogClass.error("Product price is not found on the Confirmation Page");
